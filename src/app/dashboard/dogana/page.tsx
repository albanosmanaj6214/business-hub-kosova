...
export default async function DoganaGuidePage() {
    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="space-y-2">
          {PROCEDURES.map((p, i) => fullAccess || i < 2 ? <ProcedureCard key={p.title} p={p} /> : <LockedCard key={p.title} title={p.title} summary={p.intro} />)}
        </div>
      </section>
