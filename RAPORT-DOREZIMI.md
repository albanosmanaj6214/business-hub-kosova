...
| **M10** | **Mbetje build-i në disk** | `.next.bak/` dhe `.next.prev/` (349 MB) rrinë në direktorinë e aplikacionit. `.next.bak/` dikur shkaktoi refuzim push-i nga GitHub për shkak të një file 115 MB. |
